...
# Directories
base_dirs = {
    "BaselineSmallTop": os.path.join(os.getcwd(), "data/4-corrected-baseline-smalltop/results"),
    "OverSubSmallTop": os.path.join(os.getcwd(), "data/6-oversub-smalltop/results")
}
