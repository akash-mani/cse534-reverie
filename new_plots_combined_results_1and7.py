...
# Base directory
base_dir = os.path.join(os.getcwd(), "combined_results/fulltopologybaseline-fulltopologyoversub")
...
line_style_map = {
    "BaselineFullTopology": "-",   # Solid line
    "OversubFullTopology": ":"       # Dotted line
}
