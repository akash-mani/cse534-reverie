...
# Directories
base_dirs = {
    "BaselineFullTopology": os.path.join(os.getcwd(), "data/1-baseline/results"),
    "OversubFullTopology": os.path.join(os.getcwd(), "data/7-oversub-fulltop/results")
}

# Output directory for combined files
output_dir = os.path.join(os.getcwd(), "combined_results/fulltopologybaseline-fulltopologyoversub")
