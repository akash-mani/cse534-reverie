...
int main(int argc, char *argv[])
{
    ...
    std::string confFile = "/home/akmani/personal/ns3-datacenter/simulator/ns-3.39/examples/Reverie/config-workload.txt";
    std::string cdfFileName = "/home/akmani/personal/ns3-datacenter/simulator/ns-3.39/examples/Reverie/websearch.txt";
    ...
    std::string alphasFile = "/home/akmani/personal/ns3-datacenter/simulator/ns-3.39/examples/Reverie/alphas";
